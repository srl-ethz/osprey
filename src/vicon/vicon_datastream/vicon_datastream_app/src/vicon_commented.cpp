...
int main(int argc, char *argv[]) {
  ...
  //     std::cout << " --enable_multicast <MulticastAddress:Port>" <<
  //     std::endl; std::cout
  ...
  //       a += 2;
  //     }
  //   } else if (arg == "--enable_haptic_test" || arg ==
  //   "--enable-haptic-test") {
  ...
  //   } else {
  //     std::cout << "Failed to understand argument <" << argv[a] <<
  //     ">...exiting"
  //               << std::endl;
  //     return 1;
  //   }
  ...
  //   const bool Ok =
  //       (MulticastClient.ConnectToMulticast(MulticastAdapter,
  //       MulticastAddress)
  ...
  while (!DirectClient.IsConnected().Connected) {
    ...
    //   DirectClient.StartTransmittingMulticast(Hosts.front(),
    //   MulticastAddress);
    // }
...
// Sleep a little so that we don't lumber the CPU with a busy poll
    ...
    //         OutputStream << "   SensorMode( " <<
    //         _Output_SensorMode.SensorMode
    //                      << "):" << std::endl;
    //       }
    ...
    //           OutputStream << "        # Line Positions X: "
    //                        <<
    //                        _Output_GetGreyscaleBlob.BlobLinePositionsX.size()
    //                        << std::endl;
    //           OutputStream << "        # Line Positions Y: "
    //                        <<
    ...
    //         OutputStream << "      Width:" <<
    //         _Output_GetVideoFrame.m_Width
    //                      << std::endl;
    //         OutputStream << "      Height:" <<
    //         _Output_GetVideoFrame.m_Height
    //                      << std::endl;
    //         OutputStream << "      Frame Id:" <<
    //         _Output_GetVideoFrame.m_FrameID
    //                      << std::endl;
    //         OutputStream << "      Format:" <<
    //         _Output_GetVideoFrame.m_Format
    //                      << std::endl;
    //         if (_Output_GetVideoFrame.m_Data) {
    //           OutputStream << "      Data:"
    //                        << _Output_GetVideoFrame.m_Data->size() << "
    //                        samples"
    //                        << std::endl;
    //         }
    //       }
